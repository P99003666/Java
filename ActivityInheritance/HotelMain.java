...
public class HotelMain {
	public static void main(String[] args) throws NumberFormatException, IOException {
		...
		if(roomTp==1)
		{
			DeluxRoom dlR=new DeluxRoom(hotelName, sqFt, tWVal, wValue);
		}
		else if(roomTp==2)
		{
			DeluxAcRoom dlAcR=new DeluxAcRoom(hotelName, sqFt, tWVal, wValue);
		}
		else if(roomTp==3)
		{
			SuitAcRoom sAcR=new SuitAcRoom(hotelName, sqFt, tWVal, wValue);
		}
	}
}
